...
ls *.sorted.deDup.bam | parallel --jobs 15 'java -Xmx16g -jar ../../picard.jar AddOrReplaceReadGroups I={} O={.}RG.bam RGID={.} RGLB={.} RGPL=illumina RGPU={.}.unit RGSM={.}' &&
...
#get to realigning - this will take a day or two
ls *RG.bam | \
   parallel --jobs 15 \
