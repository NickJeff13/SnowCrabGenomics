...
pops <- c(rep("Mar C", 45),rep("Mar E",45),rep("Mar B",33),rep("Quebec",33), rep("Lilly Canyon",22), rep("CMA 3B",34),rep("CMA 6B",34), rep("Torngat", 21), rep("CMA 10B",6),"Baie des Chaleurs",rep("CMA 10B",7), "Baie des Chaleurs", rep("CMA 10B", 7), "Baie des Chaleurs", rep("CMA 10B", 7), "Baie des Chaleurs", rep("CMA 10B",7), "Baie des Chaleurs", rep("CMA 4", 7), "Baie des Chaleurs", rep("CMA 4", 7), "Baie des Chaleurs", rep("CMA 4", 7), "Baie des Chaleurs", rep("CMA 4", 7),"Baie des Chaleurs", rep("CMA 4", 6), rep("Baie des Chaleurs", 12), rep("CMA 5A", 33), rep("CMA 8A", 32), rep("Lilly Canyon", 9), rep("Baie des Chaleurs", 4), rep("CMA 3N200", 10), rep("Offshore GrandBanks", 33), rep("CMA 3D", 35), rep("CFA 10A", 34), rep("St. Marys Bay", 27), rep("Fortune Bay", 35), rep("Trinity Bay", 13), rep("West Cape Breton FEMALE", 8), rep("Bradelle Bank", 44), rep("CMA 3N200", 15), rep("Torngat", 3), "St. Marys Bay", rep("Torngat", 8), rep("West Cape Breton FEMALE", 4), rep("Trinity Bay", 20), rep("Northeast NS", 25), rep("NAFO 4X", 32), rep("Northeast NS Outer", 35), rep("Labrador 6222", 33), rep("Labrador 2420", 35), rep("LaurentianChannel", 35), rep("West Cape Breton FEMALE", 54), rep("Mar D", 8), rep("West Cape Breton MALE", 65), rep("Mar D", 26))
